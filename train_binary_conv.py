...
def main():
    ...
    batch_size: int = 256
    epochs: int = 1000
    model_name = "./Vanila_Deterministic_BinaryConnect_CONV.pth"
    ...
    model = Binarized_CONV(mode="determistic",
                           is_dropout=False,
                           dropout_prob=1.0,
                           optimizer=optimizer,
    ...
    for epoch in range(epochs):
        ...
        writer.add_scalar("Vanila BinaryConnect CONV/Loss/train", train_loss, epoch)
        writer.add_scalar("Vanila BinaryConnect CONV/Loss/valid", valid_loss, epoch)
        writer.add_scalar("Vanila BinaryConnect CONV/Acc/valid", valid_acc, epoch)
